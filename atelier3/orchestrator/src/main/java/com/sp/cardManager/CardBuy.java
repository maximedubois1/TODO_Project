...
@Log4j2
public class CardBuy implements JavaDelegate {
    private static final String USER_SERVICE_URL = "http://your-user-service-host:port/buy/"; // TODO: find the great url
    ...
    public void execute(DelegateExecution delegateExecution) throws BpmnError {
        ...
        String response = new RestTemplate().postForObject(USER_SERVICE_URL + cardId + "/to-user/" + userid, "", String.class);
